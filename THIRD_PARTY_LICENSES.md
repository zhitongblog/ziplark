...
`unrar_sys` crate, which vendors and builds the UnRAR C++ source; Ziplark drives
its C API directly — see `crates/ziplark-core/src/formats/rar/raw.rs`). UnRAR is **not**
